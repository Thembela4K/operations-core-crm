<div class="grid gap-4 md:grid-cols-3">
    <label><span class="label">Request ID</span><input class="input" name="quotation_code" value="{{ old('quotation_code', $quotation->quotation_code) }}" required></label>
    <label><span class="label">Client</span><input class="input" name="client" value="{{ old('client', $quotation->client) }}" required></label>
    <label><span class="label">Request / Opportunity</span><input class="input" name="opportunity" value="{{ old('opportunity', $quotation->opportunity) }}" required></label>
